            ...
            >
                <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-10 py-3.5">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        {!isLoading && (
                            user ? (
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        <div className="w-5 h-5 bg-blue-600 rounded-full flex items-center justify-center text-[10px] font-bold uppercase flex-shrink-0">
                                            {user.username[0]}
                                        </div>
                                    ...
                                    {dropOpen && (
                                        <>
                                            ...
                                            <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-2xl shadow-xl border border-blue-50 z-20 overflow-hidden">
                                                <div className="px-4 py-3 border-b border-slate-100">
                                                    <p className="text-slate-800 font-semibold text-sm" style={{ fontFamily: "var(--font-sora)" }}>
                                                        {user.username}
                                                    </p>
                                                    {user.mobile && (
                        ...
                        {/* Hamburger — only when logged in, mobile/tablet */}
                        {user && (
                            <button
